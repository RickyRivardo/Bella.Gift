                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto " style="margin-right:350px;">
                        <!-- Authentication Links -->
                                 <li class="nav-item" >
                                    <a class="nav-link text-light" href="{{ url('home') }}" style="padding-right:50px;">Home</a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link text-light" href="{{ url('chatify') }}"  style="padding-right:50px;">Chat</a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link text-light" href="{{ url('check-out') }}"  style="padding-right:50px;">Shop</a>
                                </li>
                                 <li class="nav-item">
                                ...
                                ?>
                                                 <a class="nav-link text-light" href="{{ url('check-out') }}"  style="padding-right:50px;">Cart<span class="badge badge-danger">{{ $notif }}</span></a>
                              @if(!empty($notif))
